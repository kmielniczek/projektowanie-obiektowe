...
:x: 3.5 | Przeprowadź testy bezpieczeństwa typu Cross-Site Scripting (XSS),
próbując wstrzyknąć złośliwy kod JavaScript w aplikacji z Reactem

:x: 4.0 | Przetestuj działanie koszyka zakupowego przy jednoczesnym otwarciu
...
:x: 4.5 | Do zadania z React'a należy dodać formularz logowania. Następnie
